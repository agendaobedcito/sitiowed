...
if($del->execute()){
    unlink($ruta);
    echo alerta ('La imagen a sido eliminada','agregar_imagenes.php?clave='.$clave_producto.'');
} else {echo alerta ('La imagen no a sido eliminada','agregar_imagenes.php?clave='.$clave_producto.''); }
$del=null;
$del=null;
